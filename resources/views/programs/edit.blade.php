                        ...
                        <div class="flex md:flex-row">
                          <div class="w-full flex-1 mx-4">
                            ...
                            <div class="bg-white my-2 p-1 flex border flex-col border-blue-400 rounded svelte-1l8159u">
                              <input placeholder="Enter program code..." value="{{ $program->program_code }}" name="program_code" class="p-1 px-2 appearance-none outline-none w-full text-gray-800">
                            </div>
                          </div>
                          <div class="w-full flex-1 mx-2 svelte-1l8159u">
                            <label for="name">Program Name</label>
                            <div class="bg-white my-2 p-1 flex flex-col border border-blue-400 rounded svelte-1l8159u">
                              <input placeholder="Enter program name..." value="{{ $program->program_name }}" name="program_name" class="p-1 px-2 appearance-none outline-none w-full text-gray-800">
                            </div>
                          </div>
                        </div>
                      </div>
